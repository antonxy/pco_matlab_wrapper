...
clibgen.generateLibraryDefinition(...
    "pco_wrapper.hpp",...
    "Libraries","C:\Program Files (x86)\PCO Digital Camera Toolbox\pco.sdk\lib64\SC2_Cam.lib",...
    "PackageName","pco_wrapper",...
    "IncludePath", "C:\Program Files (x86)\PCO Digital Camera Toolbox\pco.sdk\include"...
)
